...
import { fieldLabel, isSeoField } from "@/lib/seoFields";
...
/** Which company slugs count as "this field" — mirrors the feed's field scoping. */
function fieldSlugConds(field: string) {
  if (field === "it") {
    return [
      { companySlug: "adzuna-in-it" },
      { companySlug: "jooble-in-it" },
      { companySlug: { $not: /^(?:adzuna|jooble)-in-/ } }, // ATS boards = software/product
    ];
  }
